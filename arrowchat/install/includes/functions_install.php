<?php	
	...
	*/
	...
	\$mainframe->initialise();";
		...
		if ($_SESSION['version'] == "easysocial")
			$include_data = "
	define('_JEXEC',1);
	define('DS',DIRECTORY_SEPARATOR);
	define('JPATH_BASE',dirname(dirname(dirname(__FILE__))));
	...
	\$mainframe->initialise();";
		...
		if ($_SESSION['version'] == "sharetronix")
			$include_data = "
	...
	*/
	function getFinalInstructions($version) 
	{
		switch($version)
		{
			...
			case "vanilla":
				return "In Vanilla, you can edit the header and footer files by going to the following folder: /applications/dashboard/views/.  Then, edit the default.master.php file.  Be sure that you put the code after the &lt;head&gt; tag and before the &lt;/body&gt; tag.  You can do ctrl+F to find these in the file.";
				break;
