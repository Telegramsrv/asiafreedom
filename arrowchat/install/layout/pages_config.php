		...
		<?php
			...
			else
			{
				...
				if ($result AND $db->count_select() > 0)
				{
					...
					if ($prefix_guess == "arrowchat_" OR $prefix_guess == "sys_" OR $prefix_guess == "video_" OR $prefix_guess == "core_" OR $prefix_guess == "skin_" OR $prefix_guess == "blog_" OR $prefix_guess == "cms_" OR $prefix_guess == "posts_" OR $_SESSION['version'] == "ilias")
					{
						$prefix_guess = "";
					}
				}
