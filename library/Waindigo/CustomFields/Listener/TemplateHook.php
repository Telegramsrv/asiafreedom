...
class Waindigo_CustomFields_Listener_TemplateHook extends Waindigo_Listener_TemplateHook
{
    ...
    } /* END _adminResourceCategoryEditTabs */
    ...
    } /* END _adminResourceCategoryEditPanes */
    ...
    protected function _anyMessageContent($viewParams = null)
    {
        ...
        if (isset($viewParams['forum'])) {
            ...
            if ($viewParams['thread']['first_post_id'] == $viewParams['message']['post_id']) {
                ...
                $pattern = '#</article>#';
                $replacement = '${0}' .
                     $this->_escapeDollars($this->_render('_footer_node.' . $forum['node_id'], $viewParams));
                $this->_patternReplace($pattern, $replacement);
            }
        }
    ...
    } /* END _resourceViewSidebarResourceInfo */
    ...
    } /* END _resourceViewSidebarBelowInfo */
    ...
    } /* END _waindigoSocialForumFieldsExtraSocialgroups */
    ...
    } /* END _waindigoSocialForumDescriptionSocialgroups */
    ...
    } /* END _waindigoSocialForumSidebarInfoSocialgroups */
    ...
    } /* END _waindigoSocialForumSidebarBelowInfoSocialgroups */
