...
class Waindigo_CustomFields_Model_SocialForumField extends XenForo_Model
{
    ...
    } /* END prepareSocialForumFieldConditions */
    ...
    } /* END prepareSocialForumFieldFetchOptions */
    ...
    } /* END prepareSocialForumFieldOrderOptions */
    ...
    public function getSocialForumFieldsByGroups(array $conditions = array(), array $fetchOptions = array(), &$fieldCount = 0)
    {
        ...
        return $fieldGroups;
    } /* END getSocialForumFieldsByGroups */
    ...
    } /* END getSocialForumFieldsInCategories */
    ...
    public function getSocialForumFieldsInCategory($nodeId)
    {
        ...
        return $output;
    } /* END getSocialForumFieldsInCategory */
    ...
    public function getUsableSocialForumFieldsInCategories($categoryIds, array $viewingUser = null, $verifyUsability = true)
    {
        ...
        return $fieldGroups;
    } /* END getUsableSocialForumFieldsInCategories */
    ...
    } /* END getSocialForumFieldIfInCategory */
    ...
    } /* END getCategoryAssociationsBySocialForumField */
    ...
    public function getSocialForumFieldChoices($fieldId, $choices, $master = false)
    {
        ...
        return $choices;
    } /* END getSocialForumFieldChoices */
    ...
    public function verifySocialForumFieldValue(array $field, &$value, &$error = '')
    {
        ...
        return true;
    } /* END verifySocialForumFieldValue */
    ...
    } /* END updateSocialForumFieldCategoryAssociationBySocialForumField */
    ...
    public function updateSocialForumFieldCategoryAssociationByCategory($nodeId, array $fieldIds)
    {
        ...
        XenForo_Db::commit($db);
    } /* END updateSocialForumFieldCategoryAssociationByCategory */
    ...
    public function rebuildSocialForumFieldCategoryAssociationCache($categoryIds)
    {
        ...
        XenForo_Db::commit($db);
    } /* END rebuildSocialForumFieldCategoryAssociationCache */
    ...
    public function getSocialForumFieldOptions(array $conditions = array(), array $fetchOptions = array())
    {
        ...
        return $options;
    } /* END getSocialForumFieldOptions */
    ...
    } /* END getSocialForumFieldTypeMap */
    ...
    } /* END getSocialForumFieldDescriptionPhraseName */
    ...
    } /* END getSocialForumFieldChoicePhraseName */
    ...
    } /* END getSocialForumFieldMasterTitlePhraseValue */
    ...
    public function getSocialForumFieldMasterDescriptionPhraseValue($id)
    {
        ...
        return $this->_getPhraseModel()->getMasterPhraseValue($phraseName);
    } /* END getSocialForumFieldMasterDescriptionPhraseValue */
    ...
    } /* END getDefaultSocialForumFieldValues */
    ...
    public function rebuildSocialForumFieldCache()
    {
        ...
        return $cache;
    } /* END rebuildSocialForumFieldCache */
    ...
    } /* END rebuildSocialForumFieldMaterializedOrder */
    ...
    } /* END verifySocialForumFieldIsUsable */
    ...
    } /* END _verifySocialForumFieldIsUsableInternal */
    ...
    public function getSocialForumFieldGroupById($fieldGroupId)
    {
        ...
        return $this->_getDb()->fetchRow(
            ...
            ', $fieldGroupId);
    } /* END getSocialForumFieldGroupById */
    ...
    public function getAllSocialForumFieldGroups()
    {
        return $this->fetchAllKeyed(
            ...
            ', 'field_group_id');
    } /* END getAllSocialForumFieldGroups */
    ...
    public function getSocialForumFieldGroupOptions($selectedGroupId = '')
    {
        ...
        return $options;
    } /* END getSocialForumFieldGroupOptions */
    ...
    } /* END prepareSocialForumFieldGroups */
    ...
    public function prepareSocialForumFieldGroup(array $fieldGroup)
    {
        ...
        return $fieldGroup;
    } /* END prepareSocialForumFieldGroup */
