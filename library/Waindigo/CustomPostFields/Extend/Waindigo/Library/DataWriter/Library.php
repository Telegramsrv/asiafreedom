 ...
 */
class Waindigo_CustomPostFields_Extend_Waindigo_Library_DataWriter_Library extends XFCP_Waindigo_CustomPostFields_Extend_Waindigo_Library_DataWriter_Library
{
    ...
    protected function _getFields()
    {
        ...
        $fields['xf_library']['custom_post_fields'] = array(
            'type' => self::TYPE_SERIALIZED,
            'default' => ''
        );
        $fields['xf_library']['required_post_fields'] = array(
            'type' => self::TYPE_SERIALIZED,
            'default' => ''
        );
