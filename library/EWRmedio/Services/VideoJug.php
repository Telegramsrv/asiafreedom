...
class EWRmedio_Services_VideoJug extends XenForo_Model
{
	public static function dumpMedia($service, $matches)
	{
		$client = new Zend_Http_Client('http://www.videojug.com/'.$matches['sval1']);
		...
		$media = array(
			...
			'media_value2' => str_replace('http://www.videojug.com/player/videoJugPlayer.swf?id=', '', $meta['og:video']),
