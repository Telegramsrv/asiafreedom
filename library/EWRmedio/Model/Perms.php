...
class EWRmedio_Model_Perms extends XenForo_Model
{
	public function getPermissions(array $viewingUser = null)
	{
		...
		$perms['keyword'] = (XenForo_Permission::hasPermission($viewingUser['permissions'], 'EWRmedio', 'canKeyword') ? true : false);
		...
		$perms['bulk'] = (XenForo_Permission::hasPermission($viewingUser['permissions'], 'EWRmedio', 'canBulk') ? true : false);
