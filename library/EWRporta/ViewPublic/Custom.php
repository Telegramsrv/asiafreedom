	...
	public function renderHtml()
	{
		...
		foreach ($blocks AS $block)
		{
			...
			switch($block['block_id']) {
				case 'gamesBlock': $inParams = array('games' => $this->_params['games']);
					break;
				case 'youtubers': 
					$fieldsModel =  XenForo_Model::create('AnyTV_Models_CustomUserFieldModel');
					$inParams = array('youtubers' => $fieldsModel->getFieldValuesByFieldId('youtube_id'));
					break;
				case 'latestVideos': 
					$fieldsModel =  XenForo_Model::create('AnyTV_Models_CustomUserFieldModel');
					$inParams = array('playlists' => $fieldsModel->getFieldValuesByFieldId('youtubeUploads'));
					break;
			}
			...
			$params = $blocksModel->getBlockParams($block, $page, $inParams);
